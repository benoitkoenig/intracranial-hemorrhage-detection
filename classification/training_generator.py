...
from intracranial_hemorrhage_detection.preprocess import get_all_images_id, get_tf_image, get_all_true_labels
...
def training_generator(graph):
    ...
    """
    images_list = get_all_images_id("stage_1_train")
