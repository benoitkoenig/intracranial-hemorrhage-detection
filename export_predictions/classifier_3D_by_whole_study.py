...
from intracranial_hemorrhage_detection.classification_3D.by_whole_study.predict import get_3D_classifier_prediction
...
def export():
    clear_outputs_csv("results_3D_by_whole_study")
    ...
    for slice_ids in grouped_slice_ids:
        ...
        save_image_predictions_to_outputs_csv(slice_ids, predictions, "results_3D_by_whole_study")
